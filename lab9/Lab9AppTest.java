...
public class Lab9AppTest {
    ...
    @Test
    public void test01_Lines1to8() {
        // lines 1 - 8 correspond to EXPECTED[0..7]
        assertRange(0, 7, true);
    }

    @Test
    public void test02_Lines9to16() {
        assertRange(8, 15, true);
    }

    @Test
    public void test03_Lines17to24() {
        assertRange(16, 23, true);
    }

    @Test
    public void test04_Lines25to32() {
        assertRange(24, 31, true);
    }

    @Test
    public void test05_Lines33to40() {
        assertRange(32, 39, true);
    }

    @Test
    public void test06_Lines41to42_with_ace() {
        assertRange(40, 41, true);
    }

    @Test
    public void test07_Lines41to42_without_ace() {
        assertRange(40, 41, false);
    }

    @Test
    public void test08_Lines43to50() {
